...
Originally, this docker image madded for use with Kubernetes for https://github.com/cyberindo233/AWS-EKS-Cluster-with-GPU-instances-and-miners project and not tested locally.
## Get pre built image
